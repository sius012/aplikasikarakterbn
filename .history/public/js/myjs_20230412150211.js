        ...
        if (data != null) {
            ...
            if (data.judultabel != undefined) {
                let title = data.judultabel.map(function(e){
                    return `<tr class="'tablekuy-table-title"><th class='tablekuy-table-title' style="text-align:center" colspan='${count}'>${e}</th></tr>`
                })
...
$(document).ready(function () {
    $(document).delegate(".download-pdf", "click", function () {
        ...
        $(this)
         ...
         $(this)
            .closest(".tablekuy-main-cont")
            .find(".hidden-table").children("tr").children("th[data-table-type=header]").each(function(e){
                worksheet[numberToExcelColumn(e+1)+6].s = {
                    font: {
                        bold: true
                    },
                    alignment: {
