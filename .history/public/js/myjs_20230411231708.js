...
$(document).ready(function () {
    $(document).delegate(".download-pdf", "click", function () {
        ...
        XLSX.utils.sheet_add_json(excelFile.Sheets['sheet1'], [["Laporan "]], { origin: -4, skipHeader: true });
        const dataBarisAsal = worksheet.splice(barisAsal - 1, 1)[0];
worksheet.splice(barisTujuan - 1, 0, dataBarisAsal);
