        ...
        if (data != null) {
            ...
            if (data.judultabel != undefined) {
                let title = data.judultabel.map(function(e){
                    return `<tr><th style="text-align:center" colspan='${count}'>${e}</th></tr>`
                })
                parent.parent().find(".hidden-table").prepend(title)
            }
        }
...
$(document).ready(function () {
    $(document).delegate(".download-pdf", "click", function () {
        ...
        $(this)
            .closest(".tablekuy-main-cont")
            .find(".hidden-table").children("tr").children("th").each(function(){})
