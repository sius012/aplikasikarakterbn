...
$(document).ready(function () {
    $(document).delegate(".download-pdf", "click", function () {
        ...
        XLSX.utils.sheet_add_json(excelFile.Sheets['sheet1'], [{t:"s",v:"Laporan Pelaksanaan Layanan Konseling INDIVIDUAL"}], { origin: -1, skipHeader: true });
        ...
        XLSX.writeFile(excelFile, "Laporan .xlsx");
    });
});
