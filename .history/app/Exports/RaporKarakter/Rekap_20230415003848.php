...
class Rekap implements FromView
{
    ...
    */
    ...
    {
        return view('outputeraport.rekapraportkarakter', ['listpenilaian'siswa'=>$this->listsiswa, "kelas"=>$this->listpenilaian['kelas'], "jurusan"=>$this->listpenilaian['jurusan'], "semester"=>"Ganjil"]);
    }
}
