...
class Rekap implements FromView
{
    ...
    */
    ...
    {
        return view('outputeraport.rekapraportkarakter', ['siswa'=>$this->listsiswa, "kelas"=>$this->listpenilaian['kelas'], "jurusan"=>$this->listpenilaian['jurusan'], "semester"=>$this->semester]);
    }
}
