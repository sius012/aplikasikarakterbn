...
class Rekap implements FromView
{
    ...
    */
    ...
    {
        return view('outputeraport.rekapraportkarakter', ['listpenilian'siswa'=>$this->listsiswa, "kelas"=>$this->listpenilaian['kelas'], "jurusan"=>$this->listpenilaian['jurusan'], "semester"=>"Ganjil"]);
    }
}
