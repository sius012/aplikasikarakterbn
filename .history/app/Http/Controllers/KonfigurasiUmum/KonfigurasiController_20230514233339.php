...
class KonfigurasiController extends Controller
{
    ...
    {
        $jurusan = Jurusan::withCount("siswa")->get();
    ...
    public function editjurusan(Request $req){
        ...
        $jurusan->jurusan = $req->jurusan;
        $jurusan->keterangan = $req->keterangan;
        $jurusan->save();
        Alert::success("Data jurusan berhasil diperbarui");
    ...
    public function hapusjurusan(Request $req){
        $angkatan = Jurusann::find($req->id);
        $angkatan->delete();
    }
    ...
    {
        $angkatan = Angkatan::withCount("siswa")->get();
    ...
    public function editAngkatan(Request $req){
        ...
        $angkatan = Angkatan::find($req->angkatan1);
        $angkatan->tahun_mulai = $req->tahun_mulai;
        $angkatan->tahun_selesai = $req->tahun_selesai;
        $angkatan->save();
        Alert::success("Angkatan berhasil diperbarui");
        return redirect()->back();
    }

    public function hapusAngkatan(Request $req){
        $angkatan = Angkatan::find($req->id);
        $angkatan->delete();
    }
