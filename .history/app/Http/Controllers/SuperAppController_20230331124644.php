...
class SuperAppController extends Controller
{
    ...
    public function profilsiswa($nis)
    {
        ...
        return view("datasiswa.profilsiswa", ["siswa" => $siswa, "catataneraport"=>$catatanEraport, "catatankonseling"=>$catatankonseling, "catatanNegatif"=>$catatanNegatif, "catatanNegatif"]);
    }
