...
class SuperAppController extends Controller
{
    ...
    public function profil(Request $req)
    {
        ...
        if($req->filled("dari") and $req->filled("sampai")){
            ...
            $weekdari = Carbon::parse($dat)->weekOfMonth;
            $weeksampai = Carbon::now()->weekOfMonth;
            $jadwalkonseling->whereBetween("tahun", [$yeardari,$yearsampai])->whereBetween("bulan",[$monthdari,$monthsampai])->get();
