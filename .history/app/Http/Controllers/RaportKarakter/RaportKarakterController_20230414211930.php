...
class RaportKarakterController extends Controller
{
    ...
    public function rekaperaportdetail(array $params)
    {
        ...
        UserDis::whereIn('id', $listguru)->get();
        ...
        foreach ($aspek4b as $j => $asp4b) {
            ...
            foreach ($siswa as $s => $sws) {
                ...
                $rata2penilaian = $totalpenilaian / $countpenilai;
                ...
                $rekaplist[$asp4b->no_aspek . ":" . $asp4b->no_subpoint . ":" . $asp4b->no_point]["siswa"][$sws->nis]["nilai_sekolah"]['jumlah_akumulatif'] = $countpe!= 0 ? $qpsekolah->sum("nilai") / $countsekolah : 0;
            }
        }
