...
class SuperAppController extends Controller
{
    ...
    //    dd();
        ...
        $jurusan = $jurusan->map(function($e,$i) use($angkatan) {
            ...
            $visibility = checkClassPermission(["angkatan"=>$angkatan,"jurusan"=>$jurusan,"auth"=>auth()]);
        ...
        return view("datasiswa.datajurusan", ["jurusan" => $e->jurusan, "angkatan" => $angkatan, "jurusanall" => $jurusanall]);
    }
