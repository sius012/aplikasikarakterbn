...
class SuperAppController extends Controller
{
    ...
    public function reservasikonseling(Request $req)
    {
        ...
        $reservasikonseling = $reservasikonseling->with("pemesan", "detailjk.jadwal.konselor");
        ...
        if ($req->filled("dari") and  $req->filled("sampai")) {
            ...
            $reservasikonseling = $reservasikonseling->whereHas("detailjk.jadwal", function($q) use($tahundari,$ta{
                $q->whereBetween("tahun", [$tahundari,$tahunsampai]);
            });
        }
