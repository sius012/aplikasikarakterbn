...
class SuperAppController extends Controller
{
    ...
    public function profilsiswa($nis)
    {
        ...
        $catatankonseling = BillingKonseling::where("nis_siswa", $nis)->get();

        $siswa = Siswa::with(["detail", "alamat"])->find($nis);

        return view("datasiswa.profilsiswa", ["siswa" => $siswa, "catataneraport" => $catatanEraport, "riwayat" => $catatankonseling, "catatanNegatif" => $catatanNegatif, "catatanPositif" => $catatanPositif]);
    }
