...
class SuperAppController extends Controller
{
    ...
    public function pengajuankonselingstore(Request $req)
    {
        ...
        try {
            ...
            BuatReservasi::dispatch(Auth::user()->nama_siswa,Auth::user()->kelasdanjurusan(),$djk->tanggal,$djk->tanggal,$req->keterangan,$djk->jadwal->id_konselor,Auth::user()->getimageurl());
