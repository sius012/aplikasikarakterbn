...
class DataSiswaController extends Controller
{
    ...
    public function profilsiswa($nis)
    {
        ...
        return view("datasiswa.profilsiswa", ["angkatan"=>$angkatanAll, "jurusan"=>$"siswa" => $siswa, "catataneraport" => $catatanEraport, "riwayatkonseling" => $catatankonseling, "catatanAsrama"=>$catatanasrama]);
    }
