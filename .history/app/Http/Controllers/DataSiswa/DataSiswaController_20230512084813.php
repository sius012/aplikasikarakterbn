...
class DataSiswaController extends Controller
{
    ...
    public function datajurusan($angkatan)
    {
        ...
        $jurusan = Auth::user()->getMyListJurusan($angkatan);
    ...
    {
        //check permission 
        $entryClass = Auth::user()->entryTheClass($angkatan, $jurusan);
        ...
        return view("datasiswa.siswakelas", ["siswa" => $entryClass]);
    }

    public function profilsiswa($nis)
    {
        // $kategori = Kategori::with("aspek4b")->get();
        $profilsiswa = Auth::user()->checkStudentProfile($nis);
        dd($profilsiswa);
