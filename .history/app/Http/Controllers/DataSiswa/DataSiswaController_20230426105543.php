...
class DataSiswaController extends Controller
{
    ...
    public function profilsiswa($nis)
    {
        ...
        return view("da", ["angkatan"=>$angkatanAll, "jurusan"=>$jurusanAll,"siswa" => $siswa, "catataneraport" => $catatanEraport, "riwayatkonseling" => $catatankonseling, "catatanAsrama"=>$catatanasrama]);
    }
