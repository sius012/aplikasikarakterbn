...
class SuperAppController extends Controller
{
    ...
    public function profil(Request $req)
    {
        ...
        $jadwalkonseling = JadwalKonseling::where("id_konselor", Auth::user()->id)->orderBy("tahun", "desc")->orderBy("bulan", "desc")->orderBy("minggu", "desc")->get();
    ...
    public function pengajuankonselingstore(Request $req)
    {
        ...
        if ($booked < 1) {
            ...
            Alert::error("Reservasi Berhasil", "Guru BK akan segera merespon");
            return redirect()->back();
        }
    }
