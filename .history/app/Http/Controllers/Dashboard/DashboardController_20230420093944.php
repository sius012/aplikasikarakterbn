    ...
    public function index(Request $req)
    {
        ...
        foreach($kategori as $k =>$ktg){
           ...
           "), ">", date("Y"))->orWhere(
            ...
            $angkatan = $angkatan->map(function ($akt,$i) use($ktg, $angkatan,$case) {
                $jurusan = [];
                $jumlahpelaku = [];
                ...
                return ["kelas"=>$akt->kelas(),"index_angkatan"=>$akt->id_angkatan,"jeniskasus"=>$ktg->kategori,"id_kasus"=>$ktg->id_kategori,"data"=>["jurusan"=>$jurusan,"jumlah"=>$jumlahpelaku]];
            });
