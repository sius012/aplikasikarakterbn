        ...
        if(!regularPermission($this->getRoleNames(),["Admin","Kepala Sekolah"])){
            ...
            foreach($hakAkses as $h => $ha){
                ...
                switch ($ha->jenis_kelamin) {
                    case 'L':
                        array_push($jk["L"],$angkatanList);
                        $jk["L"] = call_user_func_array("array_merge",$jk["L"]);
                        break;
                    case 'P':
                        array_push($jk["P"],$angkatanList);
                        $jk["L"] = call_user_func_array("array_merge",$jk["P"]);
                        break;
                    default:
                        array_push($jk["S"],$angkatanList);
                        $jk["S"] = call_user_func_array("array_merge",$jk["L"]);
                        break;
                }
