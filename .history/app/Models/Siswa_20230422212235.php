...
class Siswa extends Model implements Authenticatable
{
    ...
    protected $fillable = [
        "nis",  "nama_siswa", "id_jurusan", "tanggal_lahir", "tempat_lahir", "jenis_kelamin","no_absen","id_angkatan","agama","foto_profil","id_ca","status"
    ];
    ...
    public function kelas()
    {
         ...
         if($this->id_ca!=null){
            $angkatan = Angkatan::find("id_angkatan", $this->id_ca);
         }
    ...
    public function kelasdanjurusan()
    {
        ...
        return $this->kelas() < 13 ?  $this->jurusan . " " . $jurusan : "Sudah Lulus";
    }
