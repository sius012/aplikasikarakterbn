    ...
    $arr =
        ...
        [
            ...
            [
                "title" => "Beranda",
                "route" => "beranda",
                "for" => "Pamong Putra|Pamong Putri|Admin|Guru BK|Kepala Sekolah|",
                "icon" =>
                [[
...
function checkClassPermission($arr){
    ...
    $visibility = false;
    $regularpermission = regularPermission($auth->user()->getRoleNames(),["Guru BK","Admin","Kepala Sekolah","Kesiswaan"]);
