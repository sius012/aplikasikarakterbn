...
function renderRole($roles){
  ...
  /**
 * Ini adalah contoh function dengan keterangan atau docblock.
 *
 * @param string $jeneng jenenge setiap baris.
 * @param string $method jenenge setiap baris.
 * @return string Iki bakal labuhi larik.
 */
