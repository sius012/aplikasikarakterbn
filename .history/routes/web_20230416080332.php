...
Route::group(["middleware" => "auth"], function () {
    ...
    Route::resource("admin.konfigurasiumum.pengguna", KonfigurasiPenggunaController::class);
    Route::get('/konfigurasiumum/pengguna/tambah', [SuperAppController::class, "konfigurasipenggunatambah"])->name("");
