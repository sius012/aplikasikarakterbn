...
Route::controller(RaportKarakterController::class)->middleware('auth:siswa')->group(function () {
...
//Route Menu Raport Karakter(Si)
Route::controller(RaportKarakterController::class)->group(function(){
