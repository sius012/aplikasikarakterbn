...
Route::get('/siswa/login', [SuperAppController::class,"registersiswastore"])->name("siswa.login");
Route::post('/siswa/login', [SuperAppController::class,"registersiswastore"])->name("siswa.login");
