...
Route::controller(DataSiswaController::class)->middlewaregroup(function () {
    ...
    Route::get('/profilsiswa/{nis}', [SuperAppController::class, "profilsiswa"])->middle([->name('profilsiswa');
});
