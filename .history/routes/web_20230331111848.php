...
Route::group(["middleware" => "auth"], function () {
    ...
    Route::get('/carisiswa', [SuperAppController::class, "datasiswa"])->name('datasiswa');
    ...
    Route::put('/ubahjadwalreservasi', [SuperAppController::class,"ubahjadwalreservasi"])->name("bk.ubahjadwalreservasi");
});
