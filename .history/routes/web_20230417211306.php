...
Route::controller(ReservasiKonselingController::class)->middleware(["auth","role:Admin|Guru BK"])->group(function(){
...
Route::controller(JadwalKonselingController::class)->group(fun)
