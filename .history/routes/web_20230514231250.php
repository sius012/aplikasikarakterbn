...
Route::resource('hakaksessaya', HakAksesSayaController::class)->names( [
    "index"=>"hakaksessaya",
    "store"=>"guru.hakaksessaya.store",
]);
...
Route::get("/rincian", [RaportKarakterController::class, "rincian"]);
...
Route::controller(DataSiswaController::class)->middleware("auth")->group(function () {
    ...
    //hapus
    Route::post('/profilsiswa/switch', "switch")->name("datasiswa.switch");
    Route::put('/profilsiswa/switch', "turunkan")->name("datasiswa.turunkan");
    Route::post('/profilsiswa/updatepp', "updatepp")->name("datasiswa.updatepp");
    Route::put('/profilsiswa/updatesiswa', "updatesiswa")->name("datasiswa.updatesiswa");
});
...
Route::controller(KonfigurasiController::class)->middleware(["role:Admin"])->group(function () {
    ...
    Route::post('/konfigurasiumum/jurusan/edit', "editjurusan")->name("admin.konfigurasiumum.jurusan.edit");
    Route::post('/konfigurasiumum/jurusan/edit', "editjurusan")->name("admin.konfigurasiumum.jurusan.hapus");
    Route::post('/konfigurasiumum/jurusan/edit', "editjurusan")->name("admin.konfigurasiumum.jurusan.ed");
    ...
    Route::put('/konfigurasiumum/angkatan/edit/', "editangkatan")->name("admin.konfigurasiumum.angkatan.edit");
    Route::post('/hapusangkatan', "hapusAngkatan")->name("admin.konfigurasiumum.angkatan.hapus");
    Route::get('/getangkatan', 'getAngkatan')->name("getangkatan");
    ...
    Route::get('/konfigurasihakakses', 'konfigurasihakakses')->name("admin.konfigurasiumum.hak_akses");
    ...
    Route::get('/getaj', 'getaj')->name('getaj');
...
Route::controller(SiswaController::class)->middleware("auth:siswa")->group(function () {
    ...
    Route::get('/profilsaya', "profilsaya")->name('siswa.profilsaya');
});
...
Route::view('tesformku', 'test.formku');

Route::post('/submitdatatest', function(Request $req){
    return json_encode($req->input());
});

Route::get('injectphotoprofile', [GeneralController::class, "injectphotoprofile"]);
