...
Route::controller(RKGController::class)->middleware("auth")->group(function () {
...
Route::controller(KonfigurasiController::class)->middleware("middleware")->group(function () {
...
Route::controller(ReservasiKonselingController::class)->middleware(["role:Admin|Guru BK"])->group(function () {
