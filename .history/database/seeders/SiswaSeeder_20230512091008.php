...
class SiswaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $angkatan = [
            [
                "id_angkatan" => 10,
                "tahun_mulai" => "2020-05-01",
                "tahun_selesai" => "2023-08-01",
            ],
            [
                "id_angkatan" => 11,
                "tahun_mulai" => "2021-05-01",
                "tahun_selesai" => "2024-08-01",
            ],
            [
                "id_angkatan" => 12,
                "tahun_mulai" => "2022-05-01",
                "tahun_selesai" => "2025-08-01",
            ]
        ];
        ...
        $jurusan = [
            ...
            [
                "jurusan" => "DKV 1",
                "keterangan" => "Desain Komunikasi Visual 1",
            ],
            [
                "jurusan" => "DKV 2",
                "keterangan" => "Desan KOmunikasi Visual 2",
            ],
            [
                "jurusan" => "TKP",
        ...
        $array = Excel::toArray(new Raport, storage_path("file/siswa_dump.xlsx"));
        
        $listjurusan = [
            "PPLG", "DKV 1", "DKV 2", "TP", "TKP", "KULINER", "RPL", "MM", "TKRO", "BKP", "TB", "RPL", "MM", "TKRO", "BKP", "TB"
        ];
