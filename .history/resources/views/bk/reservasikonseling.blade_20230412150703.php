...
<div class="card">
    ...
    <div class="card-body">
            ...
            <table class="table" id="table-reservasi">
                ...
                <tbody>
                    @foreach($reservasikonseling $i=> as $rk)
                    <tr>
...
<script>
    $(document).ready(function() {
        $("#table-reservasi").TableKuy({
            ...
            judultabel: ["Laporan Pelaksanaan Layanan Konseling Individual","SMK Bagimu Negeriku","Semester(Ganjil/Genap)","Tahun Pelajaran 2021/2022"]
        });
