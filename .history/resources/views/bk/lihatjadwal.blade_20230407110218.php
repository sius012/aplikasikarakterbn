...
<form action="{{route('bk.updatejadwal')}}" method="POST">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col"></div>
                <div class="col"> <label for="" class="form-label">
                    Keterangan
                </label>
                <input type="text" name="keterangan" class="form-control" value="{{$jadwalkonseling["jadwal_konseling"]->keterangan}}"></div>
                <div class="col"></div>
            </div>
                            ...
                            <div class="card card-info position-absolute">
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <p class="m-3" style="font-size: 3pt">{{$jk[$j]->bookedby->first()->pemesan->nama_siswa}}</p>
