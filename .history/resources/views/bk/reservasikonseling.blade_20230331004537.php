                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning" style="font-size: 8pt; padding: 10px" data-id="{{$rk->id_pk}}"><i class="fa fa-edit"></i></button>
...
<div class="modal fade" id="modal-tanggapi" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('bk.tanggapireservasi')}}">
            @method('put')
        <div class="modal-body">
            <input type="text" class="id_pk" name="id_pk">
