                    ...
                    @for($j = 0;$j < 5;$j++) <tr class="field-input-jam">
                        ...
                        <td class="p-3 @if($jk[$j]->bookedby_count > 0) border-booked @endif" data-status="{{$jk[$j]->bookedby_count > 0 ? "booked" : "ready"}}" data-html="true" data-html="true">
                            ...
                            <div class="row">
                                <div class="col">
                                    Dari
                                    <input type="time" @if($jk[$j]->bookedby_count > 0) border-booked @endif"name="djk[{{$jk[$j]->id_djk}}]" class="form-control  jam-field" placeholder="" value="{{$jk[$j]->dari}}" readonly></div>
                                <div class="col">
                                    Sampai
                                    <input type="time" name="djk[{{$jk[$j]->id_djk}}]" class="form-control  jam-field" value="{{$jk[$j]->sampai}}" readonly></div>
                            </div>
                        </td>
                        @else
                        <td></td>
