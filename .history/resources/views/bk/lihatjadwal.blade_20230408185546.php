                ...
                <div class="container">
                    ...
                    @for($j = 0;$j < 5;$j++) <div class="row">
                        ...
                        <div class="col-sm" @if($jk[$j]->bookedby_count > 0) data-status="booked" @endif>
                            <div class="session-card @if($jk[$j]->bookedby_count > 0) @if($jk[$j]->bookedby->status="Selesai") done @elseif($jk[$j]->bookedby->first()->status="Dipesan") booked @else reschedule @endif @endif">
