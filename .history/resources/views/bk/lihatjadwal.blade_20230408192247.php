...
<form action="{{route('bk.updatejadwal')}}" method="POST">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive" style="overflow-x=scroll; width: 100000px">
                <div class="container" style="width: 100000px">
                    <div class="row">
                        @foreach($jadwalkonseling["detail"] as $i=> $jk)
                        <div class="col-md-3 p-4 fw-bolder">{{getDayName($i)}}</div>
                        @endforeach
                    </div>
                    @for($j = 0;$j < 5;$j++) <div class="row">
                        @foreach($jadwalkonseling["detail"] as $k => $jk)
                        @if(isset($jk[$j]))
                        <div class="col-md-3" @if($jk[$j]->bookedby_count > 0) data-status="booked" @endif>
