...
<div class="card">
    <div class="card-header">
        <h4>{{$jadwalkonseling["jadwal_konseling"]->}}</h4>
    </div>
    <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    @for($j = 0;$j < 5;$j++) <tr class="field-input-jam">
                        ...
                        @if(isset($jk[$j]))
                        <td class="@if($jk[$j]->bookedby_count > 0) border-booked @endif" data-status="{{$jk[$j]->bookedby_count > 0 ? "booked" : "ready"}}" data-bs-toggle="tooltip" data-html="true" data-html="true" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
                            <div class="row">
                                <div class="col">
                                    Dari
