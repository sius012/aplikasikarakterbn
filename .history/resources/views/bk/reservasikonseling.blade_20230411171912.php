...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="table-responsisve">
                <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum fugit, neque nisi quaerat tempore accusamus autem eligendi quas aperiam tenetur laboriosam aut laborum distinctio eaque dolorem? Eaque earum iusto quibusdam.</h4>
            </div>
            <table class="table" id="table-reservasi">
                <thead>
                    <tr>
                        ...
                        <th>Waktu</th>
                        <th>Tempat</th>
                        <th>Pendekatan eyang digunakan</th>
...
<script>
    $(document).ready(function() {
        $("#table-reservasi").TableKuy({
            tombol: ["print","excel","pdf"]
        });
