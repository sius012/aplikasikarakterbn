        ...
        <div class="table-responsive">
           <div class="container">
            ...
            <div class="container">
                <div class="row">
                    @foreach($jadwalkonseling["detail"] as $i=> $jk)
                    <div class="col-1">{{getDayName($i)}}</div>
                    @endforeach
                </div>
                @for($j = 0;$j < 5;$j++) <div class="field-input-jam row">
            ...
            @for($j = 0;$j < 5;$j++) <tr class="field-input-jam">
                @foreach($jadwalkonseling["detail"] as $k => $jk)
                @if(isset($jk[$j]))
                <div  class="p-3 col@if($jk[$j]->bookedby_count > 0) border-booked @endif" data-status="{{$jk[$j]->bookedby_count > 0 ? "booked" : "ready"}}" data-html="true" data-html="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            Dari
                            <input type="time" @if($jk[$j]->bookedby_count < 1) name="djk[{{$jk[$j]->id_djk}}][dari]" @endif class="form-control  jam-field" placeholder="" value="{{$jk[$j]->dari}}" readonly></div>
                        <div class="col">
                            Sampai
                            <input type="time" @if($jk[$j]->bookedby_count < 1)name="djk[{{$jk[$j]->id_djk}}][sampai]" @endif class="form-control  jam-field" value="{{$jk[$j]->sampai}}" readonly></div>
                    </div>
                </td>
                @else
                <td></td>
        ...
        <div class="container">
            <table class="table">
                <tr>
                    ...
                    <td><div class="avatar-group mt-2">
