                    ...
                    @for($j = 0;$j < 5;$j++) <div class="row">
                        ...
                        <div class="col-sm" @if($jk[$j]->bookedby_count > 0) data-status="booked" @endif>
                            @if($jk[$j]->bookedby_count > 0)
                                <div class="card card-info mb-3 position-absolute" style="max-width: 540px;">
                                    <div class="row g-0">
                                      <div class="col-md-2">
                                      ...
                                      <div class="col-md-8">
                                        <div class="card-body">
                                          ...
                                          <div class="container">
                                            ...
                                            <button type="button" class="btn btn-warning mb btn-edit-jadwal p-3 py-1" value="{{$jk[$j]->id_djk}}"><i class="fa fa-edit"></i></button>
