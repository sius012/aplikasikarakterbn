            ...
            <div class="table-responsive" style="overflow-x:scroll;">
                <div class="container" style="width: 3000px">
                    <div class="row">
                        ...
                        <div class="col p-4 fw-bolder" style="min-width: 400px">{{getDayName($i)}}</div>
                        @endforeach
                    </div>
                    @for($j = 0;$j < 5;$j++) <div class="row">
                        @foreach($jadwalkonseling["detail"] as $k => $jk)
                        @if(isset($jk[$j]))
                        <div class="col" @if($jk[$j]->bookedby_count > 0) data-status="booked" @endif style="min-width: 400px">
