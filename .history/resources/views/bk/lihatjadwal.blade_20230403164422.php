                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <button class="btn btn-warning btn-edit-jadwal p-3 py-1" value="{{$jk[$j]->id_}}"><i class="fa fa-edit"></i></button>
                                            <button class="btn btn-success btn-reserv-jadwal p-3 py-1"><i class="fa fa-check"></i></button>
                                            <button class="btn btn-danger btn-batal-jadwal p-3 py-1"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
