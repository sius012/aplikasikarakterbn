                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <button class="btn btn-success btn-edit-jadwal p-3 py-1"><i class="fa fa-edit"></i></button>
                                            <button class="btn btn-danger btn-edit-jadwal p-3 py-1"><i class="fa fa-edit"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
