      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="hidden" value="" class="id-field">
           <select name="" id="hari-select" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="row">
                <div class="col"><input type="time" class="form-control dari-field"></div>
                <div class="col"><input type="time" class="form-control sampai-field"></div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="" class="btn btn-primary">Simpan Perubahan</button>
        </div>
    </form>
      </div>
    </div>
