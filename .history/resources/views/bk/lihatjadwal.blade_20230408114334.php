                ...
                <div class="container">
                    ...
                    @for($j = 0;$j < 5;$j++) <div class="row">
                        ...
                        <div class="col-sm" @if($jk[$j]->bookedby_count > 0) data-status="booked" @endif>
                            <div class="session-card @if($jk[$j]->bookedby_count > 0) @if($jk[$j]->bookedby->first()->status="Selesai") done @elseif($jk[$j]->bookedby->first()->status="Dipesan") booked @else red @endif @endif">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body p-2">
                                                ...
                                                <div class="container">
                                                    ...
                                                    @else
                                                    <button type="button" class="btn btn-info m-0 btn-edit-jadwal p-3 py-1" value="{{$jk[$j]->id_djk}}"><i class="fa fa-info"></i></button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
