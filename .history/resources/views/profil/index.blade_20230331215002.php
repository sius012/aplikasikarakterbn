            ...
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="minggu" id="" class="form-select">
                            ...
                            <table class="table table-bordered" data-day="{{$day['lc']}}">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-le"><button type="" class="btn btn-sm btn-primary m-0 btn-jadwal">+</button></th>
                                    </tr>
                                    <tr>
                                        <th>Jam ke</th>
                                        <th>Dari</th>
    ...
    $(document).ready(function() {
        $(".btn-jadwal").click(function() {
          ...
          <tr>
            <td>${nomer.val()}</td>  
            <td>
                <input type='time' class='form-control' name='${nomer.data("day")}[${no}]["dari"]'>
            </td>
            <td><input type='time' class='form-control' name='${nomer.data("day")}[${no}]["sampai"]'></td>
            <td></td>
          </tr>
          `)
