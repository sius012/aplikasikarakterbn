                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($jk["booked"] == false) <a href=""><button class="btn bg-gradient-danger px-3 py-2 btn-hapus-jadwal"><i class="fa fa-trash "></i></button></a> @endif
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    $(document).ready(function() {
        ...
        $(".btn-jadwal").click(function() {
          ...
          <tr>
            ...
            <td><input type='time' class='form-control input-date-sampai' name='jadwal[${table.data("day")}][][sampai]' required></td>
        ...
        $(".btn-hapus-jadwal").click(function(){
            e.pre
        })
    })
