                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="minggu" id="" class="form-select" required>
                                ...
                                <option value="2" @if(1 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>>Minggu Kedua</option>
                                <option value="3" @if(1 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>>Minggu Ketiga</option>
                                <option value="4" @if(1 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>>Minggu Keempat</option>
                                <option value="5" @if(1 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>>Minggu Kelima</option>
                            </select>
                        </div>
                        <div class="form-group">
