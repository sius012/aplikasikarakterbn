    ...
    $(document).ready(function() {
        ...
        $(".btn-jadwal").click(function() {
          ...
          <tr>
            <td>${nomer.val()}</td>  
            <td>
                <input type='time' class='form-control input-date' name='jadwal[${table.data("day")}][${no}][dari]' required>
            </td>
            <td><input type='time' class='form-control input-date' name='jadwal[${table.data("day")}][${no}][sampai]' required></td>
        ...
        $(document).delegate(".input-date","change",function(){
            alert('tes');
        })
    })
