                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$jk->keterangan}}</td>
                            <td><a href="{{route('profil.lihatjadwal', ['id'=>$])}}"><button class="btn bg-gradient-info px-3 py-2"><i class="fa fa-info"></i></button></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    $(document).ready(function() {
        $(".btn-jadwal").click(function() {
          ...
          <tr>
            <td>${nomer.val()}</td>  
            <td>
                <input type='time' class='form-control' name='jadwal[${table.data("day")}][${no}][dari]' required>
            </td>
            <td><input type='time' class='form-control' name='jadwal[${table.data("day")}][${no}][sampai]' required></td>
            <td></td>
          </tr>
          `)
