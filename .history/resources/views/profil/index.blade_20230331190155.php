        ...
        <div class="modal-body">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select name="" id="" class="form-select">
                        ...
                        @for($bulan = 1; $bulan <= 12; $bulan++)
                            <option value="{{$bulan}}">{{$bulans[$bulan-1]}}</option>
                        @endfor
                    </select>
                  </div>
              <div class="form-group">
              ...
              <div class="container-fluid">
                <div class="table-responsive">
                    <table class="table table-bordered" data-da>
                        <thead>
                            <tr>
                                <th colspan="3">Hari Senin</th>
                                <th class="align-le" ><button class="btn btn-sm btn-primary m-0">+</button></th>
                            </tr>
                            <tr>
                                <th>No</th>
                                <th>Dari</th>
