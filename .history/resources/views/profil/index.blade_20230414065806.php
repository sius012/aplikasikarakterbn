                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="minggu" id="" class="form-select" required>
                                <option value="1" @if(1 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>Minggu Pertama</option>
                                <option value="2" @if(2 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>Minggu Kedua</option>
                                <option value="3" @if(3 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>Minggu Ketiga</option>
                                <option value="4" @if(4 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>Minggu Keempat</option>
                                <option value="5" @if(5 == \Carbon\Carbon::now()->weekOfMonth) selected @endif>Minggu Kelima</option>
                            </select>
                        </div>
                        <div class="form-group">
...
@push("js")
<script>
    function changemax(row){
       
        var parent = row.closest('tr');
        let value = "";

        row.val(parent.find('.input-date-dari').val())
        if(row.val().length < 1 || parent.find('.input-date-dari').val() > row.val()){
       ...
       // alert(row.val());
        ...
        if(after.is() != undefined){
            //alert('lol')
            after.hide()
            console.log(after.find('.input-date-dari'))
            changemax(after.find('.input-date-dari'));
        }
    }
    $(document).ready(function() {
        ...
        $(document).delegate(".input-date-dari", "change", function() {
            ...
            var sampai = row.find('.input-date-sampai')
