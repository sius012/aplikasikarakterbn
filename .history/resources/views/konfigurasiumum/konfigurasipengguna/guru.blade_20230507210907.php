            ...
            <table class="table align-items-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">Agama</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-xs text-center text-secondary mb-0">{{$ha->kelas}}</p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs text-center text-secondary mb-0">{{$ha->jurusan}}</p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs text-center text-secondary mb-0">{{$ha->agama}}</p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs text-center text-secondary mb-0">{{$ha->jenis_kelamin}}</p>
                        </td>
            ...
            <form action="{{route("admin.konfigurasiumum.pengguna.hak.tambah")}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="semua_angkatan">
                        <label class="form-check-label" for="exampleCheck1">Semua Angkatan</label>
                    </div>    
                    <div class="form-group mb-3">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="semua_jurusan">
                        <label class="form-check-label" for="exampleCheck1">Semua Jurusan</label>
                    </div> 
                    <div class="form-group mb-3">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="semua_agama">
                        <label class="form-check-label" for="exampleCheck1">Semua Agama</label>
                    </div> 
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1" name="semua_agama">
                        <label class="form-check-label" for="exampleCheck1">Jenis Kelamin/label>
                    </div> 
                    <div class="form-group mb-3">
