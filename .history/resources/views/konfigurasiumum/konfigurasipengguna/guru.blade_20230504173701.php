...
<script>
    $(document).ready(function() {
                ...
                , success: function(data) {
                    ...
                    switch (params) {
                        case "angkatan":
                         ...
                         case "jurusan":
                            list = data.map(function(e) {
                                return ` <li class="list-group-item"><a href="#" class="add-item" data-type="jurusan" data-val="${e["id_jurusan"]}">${e['jurusan']}</a> </li>`
                            })
                        default:
                            break;
                    }
        ...
        $(document).delegate(".add-item", "click",function(){
           ...
           childinput.append(`
                                <div class="input-cont m-2">
                                    <span class="badge bg-danger x">RPL <a href="#" class="text-white remove-item">${$(this).data('val')}</a></span>
                                    <input type="hidden">
                                </div>
           `)
        })
