                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-parent">
                            ...
                            <ul class="list-group position-absolute" style="width: 100px" id="angkatan">
                                <li class="list-group-item"><a href="">Tesss</a> </li>
                            </ul>
...
<script>
    $(document).ready(function() {
                    ...
                    switch (params) {
                        case "angkatan":
                            list = data.map(function(e) {
                                return ` <li class="list-group-item"><a href="#" class="add-item" data-type="angkatan" data-val="${e["id_angkatan"]}">${e['id_angkatan']}</a> </li>`
                            })
                            break;
                         case "jurusan":
                            list = data.map(function(e) {
                                return ` <li class="list-group-item"><a href="#" class="add-item" data-type="jurusan" data-val="${e["id_jurusan"]}" data-lanel>${e['jurusan']}</a> </li>`
                            })
                        default:
                            break;
                    }
        ...
        $(document).delegate(".add-item", "click",function(){
           ...
           childinput.append(`
                                <div class="input-cont m-2">
                                    <span class="badge bg-danger x">${$(this).data('val')} <a href="#" class="text-white remove-item">X</a></span>
                                    <input type="hidden">
                                </div>
           `)
        })
