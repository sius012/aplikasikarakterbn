...
<script>
    $(document).ready(function() {
                    ...
                    switch (params) {
                        case "angkatan":
                            list = data.map(function(e) {
                                return ` <li class="list-group-item"><a href="#" class="add-item" data-type="angkatan" data-id="${e["id_angkatan"]}">${e['id_angkatan']}</a> </li>`
                            })
                            break;
                         case "jurusan":
                            list = data.map(function(e) {
                                return ` <li class="list-group-item"><a href="#" class="add-item" data-type="jurusan" data-id="${e["id_jurusan"]}">${e['jurusan']}</a> </li>`
                            })
                        default:
                            break;
                    }
        ...
        $(document).delegate(".add-item", "click",function(){
           ...
           childinput.append( <div class="child-input d-flex">
                                <div class="input-cont m-2">
                                    <span class="badge bg-danger x">RPL <a href="#" class="text-white remove-item">X</a></span>
                                    <input type="hidden">
                                </div>
