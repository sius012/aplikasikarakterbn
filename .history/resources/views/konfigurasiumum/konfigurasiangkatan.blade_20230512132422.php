        ...
        $(".btn-edit-angkatan").click(function(){
            $.ajax({
                ...
                success: function(data){
                    $("#modal-edit-angkatan").find("input[name=angkatan]").val(data['id_angkatan']);
                    $("#modal-edit-angkatan").find("input[name=tahun_mulai]").val(data['tahun_selesai']);
                    $("#modal-edit-angkatan").find("input[name=tahun_selesai]").val(data['bulan_selesai']);
                    modalEdit.show();
                }
            })
        })
