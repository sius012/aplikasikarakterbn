    ...
    <table class="m-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td valign="center" style="background: #FFC000">{{$lsr['point']}}</td>
            ...
            <tr  >
                ...
                <td valign="center" style="background: #C4D79B">{{$lsr["subpoint"]}}</td>
                @foreach($siswa as $s => $sws)
            ...
            <tr>
                ...
                <td valign="center">{{$lsr['aspek']}}</td>
                @foreach($lsr["siswa"] as $key => $sis)
                <td align="center" valign="center" class="has-tooltips" data-header="Jumlah Penilai" data-jumlah="{{$sis['nilai_sekolah']['jumlah'] }}">{{$sis["nilai_sekolah"]["jumlah_akumulatif"]}}</td>
                <td align="center" valign="center" style="background: #E6B8B7">{{hurufDari($sis["nilai_sekolah"]["jumlah_akumulatif"])["huruf"]}}</td>
                @endforeach
            </tr>
            @endforeach
        </tbody>
