...
<body>
    <table>
        <tr></tr>
        <tr>
            <th colspan="5">Siswa yang mendapatkan nilai satu</th>
        </tr>
        <tr>
            <th>No</th>
            <th>Nama Siswa</th>
        ...
        <tr>
            <th  colspan="5">Siswa yang mendapatkan nilai satu (dari catatan asrama)</th>
        </tr>
        <tr>
            <th>No</th>
            <th>Nama Siswa</th>
        ...
        @foreach($rincian['asrama'] as $i => $ra)
            <tr>
                ...
                <td>{{$ra->keterangan}}</td>
                <td>
                    @foreach($ra->kategori->aspekTerkait() as $rak)
                        <p>{{$rak->keterangan}}</p>
                    @endforeach
                </td>
            </tr>
