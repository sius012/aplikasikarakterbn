    ...
    <table class="table-custom">
        <thead>
            <tr>
                ...
                <td colspan="7" font-weight: bold>RAPOR KARAKTER SISWA TAHUN PELAJARAN 2022/2023
                </td>
                @endforeach
            </tr>
            <tr>
            ...
            <tr>
                @foreach($siswa as $s => $sws)
                <td font-weight: bold>Nama Siswa</td>
                <td>:</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" valign="center"align="center" style="font-weight: bold">{{$point}}</td>
                <td colspan="5" valign="center" style="font-weight: bold">{{$rl["point"]}}</td>
                @endforeach
            </tr>
            @php
            $c_point = $rl["point"];
