    ...
    <table class="table-custom">
        ...
        <tbody>
            ...
            <tr>
                ...
                @foreach($rl["siswa"] as $s => $sws)
                <td colspan="2" align="center" style="border: 2px solid black">{{$aspek}}</td>
            ...
            <tr>
                @foreach($siswa as $s => $sks)
                    ...
                    <td></td>
                    <td></td>
                    <td colspan="3">Semarang {{date('d M Y')}}</td>
                @endforeach
            </tr>
            <tr>
                @foreach($siswa as $s => $sks)
            ...
            <tr>
                @foreach($siswa as $s => $sks)
                    ...
                    <td>.....................</td>
                    <td></td>
                    <td colspan="3">{{$walikelas != null ? $walikelas->guru->name : ""}}</td>
                @endforeach
            </tr>
            <tr>
                @foreach($siswa as $s => $sks)
            ...
            <tr>
                @foreach($siswa as $s => $sks)
                    <td colspan="7" align="center">Kepala SMK Bagimu Negeriku Semarang</td>
                @endforeach
            </tr>
            <tr>
                @foreach($siswa as $s => $sks)
            ...
            <tr>
                @foreach($siswa as $s => $sks)
                    <td></td>
                    <td></td>
                    <td align="right">Drs. Christianus Dwi Estafianto</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
