    ...
    <table class="table-custom">
        <thead>
            <tr>
                ...
                <td colspan="7" style="font-weight: bold;border: 2px solid black" align="center" valign="center">RAPOR KARAKTER SISWA TAHUN PELAJARAN 2022/2023
                </td>
                @endforeach
            </tr>
            <tr>
            ...
            <tr>
                @foreach($siswa as $s => $sws)
                <td style="font-weight: bold;border: 2px solid black">Nama Siswa</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td  valign="center" style="border: 2px solid black">{{$rl["aspek"]}}</td>
