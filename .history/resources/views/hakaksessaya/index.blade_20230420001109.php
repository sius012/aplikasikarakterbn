                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$ha->sampai}}</td>
                            <td>
                               <div class="btn-group"><form action="{{ route('categories.destroy', 1) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit">Delete Category</button>
                            </form>
                                    @if($ha->status == "await")
                                        <a class="btn btn-danger btn-sm" href="{{route('hakaksessaya.destroy',$ha->id)}}"><i class="fa fa-trash"></i></a>
                                    @endif
                               </div>
                            </td>
                        </tr>
