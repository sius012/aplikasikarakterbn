          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="cth(Wali Kelas, Guru Bhs. Indo, dll)" required>
              ...
              <div class="mb-3">
                ...
                <select name="" id="" class="form-select">
                    @foreach($angkatan as $a => $akt)
                        <option value="{{$akt->id_angkatan}}" name="angkatan" required>{{$akt->id_angkatan}}</option>
                    @endforeach
                </select>
              </div>
              <div class="mb-3">
