    ...
    <div class="container card">
        ...
        <div class="row">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#aspek{{$i}}" type="button" role="tab" aria-controls="aspek" aria-selected="true">Aspek Terkait</button>
                </li>
              </ul>
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="aspek{{$i}}" role="tabpanel" aria-labelledby="aspek-tab">
                <div class="container p-3">
                  <details>
                    <summary>Aspek Terkait</summary>
                  
                  <p class="@if($cs->kategori->tindakan == 'Negatif') text-danger @else text-success @endif">@foreach($cs->kategori->aspekTerkait() as $at)
                    <b>{{$at->point}}</b> </nav>{{$at->keterangan}}<br>
                  @endforeach</p>
                </details>
                </div>
