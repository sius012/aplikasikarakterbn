                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>NIS</th>
                                        <td><input type="number" name="nis" value="{{$siswa->na}}" class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>Nama</th>
                                        <td><input type="number" name="nama_siswa" value="{{$siswa->nama_siswa}}" class="form-control" readonly required></td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Kelamin</th>
                                        <td><input type="number" name="jenis_kelamin" class="form-control editable-field " value="{{$siswa->nisn}}" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>Angkatan</th>
                                        <td><input type="number" name="" value="{{$siswa->nis}}" class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>Jurusan</th>
