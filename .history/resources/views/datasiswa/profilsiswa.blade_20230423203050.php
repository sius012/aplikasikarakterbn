                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>No.Telp Wali</th>
                                        <td><input type="number" name="telp_wali" class="form-control editable-field" @if($siswa->detail->telp_wali != null) value="{{$siswa->detail->telp_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
