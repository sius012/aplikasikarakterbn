                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Alamat Wali</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->alamat_wali != null) value="{{$siswa->alamat_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Wali</th>
                                        <td><input type="number" class="form-control" @if($siswa->detail->telp_wali != null) value="{{$siswa->telp_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>Hubungan dengan Wali</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->telp_wali != null) value="{{$siswa->detail->hub_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->hub_Wali}}</td>
                                    </tr>
                                    <tr>
