        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>{{$siswa->status()}}</td>
                    <td>
                        <form action="{{route('datasiswa.nonaktifkan')}}" method="POST">
                        @csrf
                        <input type="hidden" value="{{$siswa->nis}}">
                        </form>
                        <button class="btn btn-danger">Nonatifkan</button>
                        <a href=""><button class="btn btn-danger">Turunkan</button></a>
                    </td>
                </tr>
            </table>
            <nav>
