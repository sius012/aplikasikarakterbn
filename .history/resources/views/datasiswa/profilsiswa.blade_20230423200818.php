                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Nama</th>
                                        <td><input type="number" name="nama_siswa" value="{{$siswa->nama_siswa}}" class="form-control editable-field" readonly required></td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Kelamin</th>
                                        <td><input type="number" name="jenis_kelamin" class="form-control editable-field " value="{{$siswa->jenis_kelamin}}" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>Angkatan</th>
