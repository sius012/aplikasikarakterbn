...
<div class="container ">
    ...
    <div class="row justify-content-md-center">
        @foreach($angkatan as $i => $kls)
        <div class="col-md-4">
            @php
            $jumlahsiswa = 10;
            $labelkelas = $kls->kelas();
            $angkatan = $kls->id_angkatan;
            @endphp
...
<div class="modal fade" tabindex="-1" id="modal-tambah-siswa">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{route('datajurusan.tambahsiswa')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="form-label">No Absen <span style="color: red">*</span></label>
