                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Alamat Wali</th>
                                        <td><input type="text" name="" class="form-control editable-field" @if($siswa->detail->alamat_wali != null) value="{{$siswa->alamat_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Wali</th>
