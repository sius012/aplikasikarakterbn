                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Nama Ayah</th>
                                        <td><input type="text" name="" @if($siswa->detail->nama_ayah == null)  placeholder="lengkapi" @else value="{{$siswa->detail->nama_ayah}}" readonly @endif class="form-control editable-field"></td>
                                    </tr>
                                    <tr>
