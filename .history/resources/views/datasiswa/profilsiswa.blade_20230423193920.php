                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Alamat Ayah</th>
                                        <td><input type="text" name="" class="form-control editable-field" @if($siswa->detail->alamat_ayah != null)  readonly value="{{$siswa->detail->alamat_ayah}}" @else placeholder="lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Ayah</th>
