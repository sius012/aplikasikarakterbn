                            ...
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="" class="form-control editable-field" @if($siswa->detail->telp_wali != null) value="{{$siswa->detail->hub_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->hub_Wali}}</td>
                                    </tr>
                                    <tr>
