                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Alamat Ibu</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->alamat_ibu != null) value="{{$siswa->detail->alamat_ibu}}" readonly @else placeholder=  @endif>{{$siswa->alamat_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Ibu</th>
