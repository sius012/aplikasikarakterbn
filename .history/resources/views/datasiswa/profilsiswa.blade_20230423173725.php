                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>No.Telp Ibu</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->telp_ibu != null)  value="{{$siswa->detail->telp_ibu}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->telp_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Wali</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->nama_wali != null) value="{{$siswa->detail->nama_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->detail->nama_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Wali</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->pekerjaan_wali != null) value="{{$siswa->detail->pekerjaan_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->pekerjaan_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Wali</th>
