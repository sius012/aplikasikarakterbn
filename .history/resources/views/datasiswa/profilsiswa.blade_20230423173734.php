                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" class="form-control" @if($siswa->alamat->rt != null) value="{{$siswa->alamat->rt}}" readonly @else placeholder="Lengkapi" @endif>
                                                </div>
                                                <div class="col">
                                                    <input type="text" class="form-control" @if($siswa->alamat->rw != null) value="{{$siswa->alamat->rw}}" readonly @else placeholder="Lengkapi" @endif>
                                                </div>
                                            </div>
                                          </th>
                                    </tr>
