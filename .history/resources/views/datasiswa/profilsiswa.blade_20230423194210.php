                            ...
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name=""  class="form-control editable-field" @if($siswa->detail->pekerjaan_wali != null) value="{{$siswa->detail->pekerjaan_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->pekerjaan_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Wali</th>
