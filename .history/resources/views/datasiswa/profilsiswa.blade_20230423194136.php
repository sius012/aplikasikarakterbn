                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Pekerjaan Ibu</th>
                                        <td><input type="text" name="" class="form-control editable-field" @if($siswa->detail->pekerjaan_ibu != null) value="{{$siswa->detail->pekerjaan_ibu}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->pekerjaan_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Ibu</th>
