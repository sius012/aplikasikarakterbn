                            ...
                            <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                        <div class="d-flex flex-column">
                                          ...
                                          <span class="mb-2 text-xs">Tanggal Penilaian: <span class="text-dark font-weight-bold ms-sm-2">{{$ce->created_at}}</span></span>
                                          <span class="mb-2 text-xs">Kasus: <span class="text-dark ms-sm-2 font-weight-bold">{{$ce->aspek_dpg->aspek4_b->keterangan}}</span></span>
