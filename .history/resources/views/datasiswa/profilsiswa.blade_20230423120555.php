                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>No.Telp Ayah</th>
                                        <td><input type="text" @if($siswa->detail->telp_ayah != null) value="{{$siswa->detail->telp_ayah}}" readonly @else placeholder="Lengkapi"  @endif class="form-control">{{$siswa->telp_ayah}}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Ibu</th>
                                        <td><input type="text" @if($siswa->detail->nama_ibu) value="{{}}" @endif>{{$siswa->detail->nama_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Ibu</th>
