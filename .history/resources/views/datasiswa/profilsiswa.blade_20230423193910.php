                            ...
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="nama_ibu" class="form-control editable-field" @if($siswa->detail->pekerjaan_ayah != null) readonly  value="{{$siswa->detail->pekerjaan_ayah}}" @else placeholder="Lengkapi" @endif> </td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Ayah</th>
