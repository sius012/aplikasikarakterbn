                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>NISN</th>
                                        <td><input type="number" class="form-control editable-field " value="{{$siswa->nisn}}" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>NIK</th>
                                        <td><input type="number" class="form-control editable-field editable-field" value="{{$siswa->detail->nik}}" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>TTL</th>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" class="form-control editable-field" value="{{$siswa->tempat_lahir}}" readonly>
                                                </div>
                                                <div class="col">
                                                    <input type="date" class="form-control editable-field" value="{{$siswa->tanggal_lahir}}" readonly>
                                                </div>
                                            </div>
                                            </td>
                                    </tr>
                                    <tr>
                                        <th>Agama</th>
                                        <td><input type="text" class="form-control editable-field" value="{{$siswa->agama}}" readonly></td>
                                    </tr>
                                    <tr>
                                        <th>Hobi</th>
                                        <td><input class="form-control editable-field" type="text" @if($siswa->detail->hobi == null) placeholder="Lengkapi" @else {{$siswa->detail->hobi}} @endif> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Nama Ayah</th>
                                        <td><input type="text" @if($siswa->detail->nama_ayah == null)  placeholder="lengkapi" @else value="{{$siswa->detail->nama_ayah}}" readonly @endif class="form-control editable-field"></td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Ayah</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->pekerjaan_ayah != null) readonly  value="{{$siswa->detail->pekerjaan_ayah}}" @else placeholder="Lengkapi" @endif> </td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Ayah</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->alamat_ayah != null)  readonly value="{{$siswa->detail->alamat_ayah}}" @else placeholder="lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Ayah</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->telp_ayah != null) value="{{$siswa->detail->telp_ayah}}" readonly @else placeholder="Lengkapi"  @endif class="form-control editable-field">{{$siswa->telp_ayah}}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Ibu</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->nama_ibu != null ) value="{{$siswa->detail->nama_ibu}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Ibu</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->pekerjaan_ibu != null) value="{{$siswa->detail->pekerjaan_ibu}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->pekerjaan_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Ibu</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->alamat_ibu != null) value="{{$siswa->detail->alamat_ibu}}" readonly @else placeholder="Lengkapi"  @endif>{{$siswa->alamat_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Ibu</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->telp_ibu != null)  value="{{$siswa->detail->telp_ibu}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->telp_ibu}}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Wali</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->nama_wali != null) value="{{$siswa->detail->nama_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->detail->nama_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Wali</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->pekerjaan_wali != null) value="{{$siswa->detail->pekerjaan_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->pekerjaan_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Alamat Wali</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->alamat_wali != null) value="{{$siswa->alamat_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>No.Telp Wali</th>
                                        <td><input type="number" class="form-control editable-field" @if($siswa->detail->telp_wali != null) value="{{$siswa->telp_wali}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>Hubungan dengan Wali</th>
                                        <td><input type="text" class="form-control editable-field" @if($siswa->detail->telp_wali != null) value="{{$siswa->detail->hub_wali}}" readonly @else placeholder="Lengkapi" @endif>{{$siswa->hub_Wali}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Alamat</th>
                                        <th><input type="text" class="form-control editable-field" @if($siswa->alamat->alamat != null) value="{{$siswa->detail->alamat}}" readonly @else placeholder="Lengkapi" @endif ></th>
                                    </tr>
                                    <tr>
                                        <th>RT/RW</th>
                                        ...
                                        <th>
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" class="form-control editable-field" @if($siswa->alamat->rt != null) value="{{$siswa->alamat->rt}}" readonly @else placeholder="Lengkapi" @endif>
                                                </div>
                                                <div class="col">
                                                    <input type="text" class="form-control editable-field" @if($siswa->alamat->rw != null) value="{{$siswa->alamat->rw}}" readonly @else placeholder="Lengkapi" @endif>
                                                </div>
                                            </div>
                                          </th>
                                    </tr>
                                    <tr>
                                        <th>Dusun</th>
                                        <th>
                                            <input type="text" class="form-control editable-field" @if($siswa->alamat->dusun != null) value="{{$siswa->alamat->dusun}}" readonly @else placeholder="Lengkapi" @endif>
                                           </th>
                                    </tr>
                                    <tr>
                                        <th>Kelurahan</th>
                                        <th><input type="text" class="form-control" @if($siswa->alamat->kelurahan != null) value="{{$siswa->alamat->kelurahan}}" readonly @else placeholder="Lengkapi" @endif></th>
                                    </tr>
                                    <tr>
                                        <th>Kecamatan</th>
                                        <th><input type="text" class="form-control" @if($siswa->alamat->kecamatan != null) value="{{$siswa->alamat->kecamatan}}" readonly @else placeholder="Lengkapi" @endif></th>
                                    </tr>
                                    <tr>
                                        <th>Kode Pos</th>
                                        <th><input type="text" class="form-control" @if($siswa->alamat->kode_pos != null) value="{{$siswa->alamat->kode_pos}}" readonly @else placeholder="Lengkapi" @endif></th>
                                    </tr>
                                </table>
                            </div>
                        </div>
