                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Kecamatan</th>
                                        <th><input type="text" name="" class="form-control editable-field" @if($siswa->alamat->kecamatan != null) value="{{$siswa->alamat->kecamatan}}" readonly @else placeholder="Lengkapi" @endif></th>
                                    </tr>
                                    <tr>
                                        <th>Kode Pos</th>
