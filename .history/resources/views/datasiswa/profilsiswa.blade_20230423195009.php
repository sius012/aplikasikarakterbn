                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Kelurahan</th>
                                        <th><input type="text" name="kelu" class="form-control editable-field" @if($siswa->alamat->kelurahan != null) value="{{$siswa->alamat->kelurahan}}" readonly @else placeholder="Lengkapi" @endif></th>
                                    </tr>
                                    <tr>
                                        <th>Kecamatan</th>
