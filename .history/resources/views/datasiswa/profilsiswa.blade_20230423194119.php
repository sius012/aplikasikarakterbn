                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Nama Ibu</th>
                                        <td><input type="text" name="" class="form-control editable-field" @if($siswa->detail->nama_ibu != null ) value="{{$siswa->detail->nama_ibu}}" readonly @else placeholder="Lengkapi" @endif></td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Ibu</th>
