                        ...
                        <div class="card-body px-0 py-0">
                            <div class="responsive-table px-0 py-0">
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Nama Wali</th>
                                        <td><input type="text" class="form-control" @if($siswa->detail->nama_wali != null) value="{{$siswa->detail->nama_wali}}" readonly @else placeholder="Lengkapi">{{$siswa->detail->nama_wali}}</td>
                                    </tr>
                                    <tr>
                                        <th>Pekerjaan Ibu</th>
