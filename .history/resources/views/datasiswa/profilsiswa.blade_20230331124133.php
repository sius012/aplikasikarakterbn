        ...
        <div class="container">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Catatan Eraport</button>
                 ...
                 @if(in_array( Auth::user()->getRoleNames()->first(), ["Pamong Putra","Pamong Putri", "Kesiswaan", "Kepala Sekolah","Admin"])) <button class="nav-link" id="nav-catatanasrama-tab" data-bs-toggle="tab" data-bs-target="#nav-catatanasrama" type="button" role="tab" aria-controls="nav-catatanasrama" aria-selected="false">Catatan Asrama</button> @endif
                </div>
              </nav>
                        ...
                        <div class="card-body py-0">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($catatankonseling as $ck)
                                            <tr>
                                                <th>Tanggal {{$ck->tanggal}}</th>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="font-weight-bold">Catatan Konselor</td>
                                                <td>{{$ck->catatan_konselor}}</td>
                                            </tr>
                                            <tr>
