                            ...
                            <div class="responsive-table px-0 py-0">
                                ...
                                <table class="table px-0 py-0">
                                    ...
                                    <tr>
                                        <th>Jurusan</th>
                                        <td>
                                            <select name="id_angkatan" id="" class="form-control editable-field">
                                                @foreach($jurusan as $jrs)
                                                    <option value="{{$jrs->id_angkatan}}" @if($siswa->id_angkatan == $akt->id_angkatan)  selected  @endif>{{$akt->id_angkatan}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                    </tr>
