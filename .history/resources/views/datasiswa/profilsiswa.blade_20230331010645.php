        ...
        <div class="container">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                 ...
                 @if(in_array("Guru BK", Auth::user()->getRoleNames())) <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Riwayat Konseling</button> @endif
                </div>
              </nav>
