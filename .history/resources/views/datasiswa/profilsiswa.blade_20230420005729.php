            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-rp" role="tabpanel">
                    <div class="container mt-3">
                        @foreach($catatanAsrama as $key => $value)
                            
                        @endforeach
                        <div class="card" >
                            <div class="row">
                                <div class="col-3">
                                    <img style="width: 100%; border-radius: 30px" class="m-1"  src="http://127.0.0.1:8000/siswa/10/RPL/2_10_1011342_.jpg" alt="">
                                </div>
                                <div class="col">
                                    <div class="card-body">
                                        <h5 class="card-title">Bermain Bola</h5>
                                        <p>Anak ini sudah membantu</p>
                                        <p>Kategori: <b>Merokok</b></p>
                                    </div>
                                </div>
