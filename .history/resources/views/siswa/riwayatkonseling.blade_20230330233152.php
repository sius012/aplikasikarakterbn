            ...
            <table class="table align-items-center mb-0">
                <tbody>
                    @foreach($riwayat as $i => $rwt)
                        <tr>
                            <th colspan="2" class="text-uppercase text-secondary text-xs font-weight-bolder opacity-8">{{$rwt->tanggal}}</th>
                            <td>
                                <span class="badge {{renderStatusReservasi($rwt->status)}}">{{$rwt->status}}</span>
                            </td>
                        </tr>
                        <tr>
                            <th colspan="2" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-8"></th>
                            <td>
                            </td>
                        </tr>
                        <tr>
