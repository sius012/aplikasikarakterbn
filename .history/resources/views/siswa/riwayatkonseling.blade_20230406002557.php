        ...
        <ul class="list-group">
            ...
            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
              <div class="d-flex flex-column">
                ...
                @if($rwt->status == 'Reschedule')<span class="mb-2 text-xs">Status: <span class="badge {{renderStatusReservasi($rwt->status)}}">{{$rwt->status}}</span></span>
                <span class="text-xs">Keterangan Reschedule: <span class="badge {{renderStatusReservasi($rwt->status)}}">{{$rwt->detailjk->keterangan_reschedule}}</span></span>@endif
              </div>
