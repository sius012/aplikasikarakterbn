        ...
        <ul class="list-group">
            ...
            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
              <div class="d-flex flex-column">
                ...
                <span class="mb-2 text-xs">Hari/Tanggal: <span class="text-dark font-weight-bold ms-sm-2">{{getDates($rwt->detailjk->jadwal->bulan,$rwt->detailjk->jadwal->bulan,$rwt->detailjk->jadwal->bulan,$rwt->detailjk->jadwal->bulan,$rwt->detailjk->jadwal->bulan)}}</span></span>
