...
@push("js")
<script>
    function renderCase(element, case){
      const ctx = element[0];
                const colors = [
                ...
                // Define chart data
                var dataangkatan = case['data'].map(function(e, i) {
                    return {
                        label: 'Kelas ' + e['kelas']
                        , data: e["jumlahpelaku"]
                ...
                const chartData = {
                    labels: case["data"][0]["labelJurusan"]
        ...
        $.ajax({
            ...
            , success: function(data) {
                for(var i = 0; i<data.length;i++){
                  let classcanvas = "canvas-"+data[$i]["jeniskasus"]
                  $("#container-case").append(`
                      <div class="col-md-5">
                        <canvas id="canvas-${data[i]['jeniskasus']}"></canvas>  
                      </div>
