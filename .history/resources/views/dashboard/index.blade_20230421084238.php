...
@section('branch1', 'Dashboard')
@section('branch2', 'Dashboard')
@section('content')
<div class="container">
        ...
        $.ajax({
            ...
            , success: function(data) {
                ...
                for (var i = 0; i < data['jumlahsiswa'].length; i++) {
                    let classcanvas = "canvas-statistika-" + data['jumlahsiswa'][i]["kelas"];
                    ...
                    `)
                    renderKelas(data['jumlahsiswa'][i], $("#"+classcanvas));
                }
